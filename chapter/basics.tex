...
\begin{equation}
\label{eq_waterflow} 
 \dot{V}_\mathrm{turbine} = \min(\dot{V}_\mathrm{n},\dot{V})
\end{equation}
...
\begin{equation}
 \label{eq_power_2} 
 P = \rho_\mathrm{water} \cdot g \cdot \min(\dot{V}_\mathrm{n},\dot{V}) \cdot (h_\mathrm{n} +W_\mathrm{n}-W) \cdot \eta_\mathrm{turbine} \cdot \eta_\mathrm{generator}
\end{equation}
