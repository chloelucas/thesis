...
\begin{figure}[H]
\begin{center}
  \subfigure[Power plants and river layers]{\framebox{\includegraphics[width=6.5cm]{empty.png}}}
  \subfigure[Search rivers within {\unit[2]{km}} of plants]{\framebox{\includegraphics[width=6.5cm]{kreis.png}}}\\
  \subfigure[Measure shortest distance to each river]{\framebox{\includegraphics[width=6.5cm]{kreis_many_lines.png}}}
  \subfigure[Keep the closest river]{\framebox{\includegraphics[width=6.5cm]{kreis_line.png}}}
\end{center}
