...
\documentclass[
		...
		twoside=true,		% Layout für einseitigen Druck
...
% Vermeiden que la dernière phrase soit sur la page suivante
...
%	\lstlistoflistings
	...
	\include{./chapter/list_scientific_symbols}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\include{./chapter/data_basis}
	\include{./chapter/methodology_new}
	\include{./chapter/simulation_model}
